...
class TestOptions:
	...
	def initialize(self):
		...
		self.parser.add_argument('--target_path', type=str, default='gt_images', help='Path to directory of images to evaluate')
		...
		self.parser.add_argument('--fixed_random_appearance', action='store_true', help='Whether to learn in w space instead of w+')
