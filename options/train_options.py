...
class TrainOptions:
	...
	def initialize(self):
		...
		self.parser.add_argument('--augmentation', action='store_true', help='Whether to learn in w space insteaf of w+')
		self.parser.add_argument('--mask_feat_layer', default=4, type=int, help='Batch size for training')
		self.parser.add_argument('--break_layer', default=8, type=int, help='Batch size for training')
		self.parser.add_argument('--seed', default=666, type=int, help='Output size of generator')
		self.parser.add_argument('--scale', default=10, type=int, help='Output size of generator')
		self.parser.add_argument('--W_plus_encodoer_only', action='store_true', help='Whether to learn in w space insteaf of w+')
		self.parser.add_argument('--W_encodoer_only', action='store_true', help='Whether to learn in w space insteaf of w+')
		self.parser.add_argument('--fixed_coarse_encoder', action='store_true', help='Whether to learn in w space insteaf of w+')
		...
		self.parser.add_argument('--random_appearance', action='store_true', help='Whether to learn in w space instead of w+')
		self.parser.add_argument('--w_norm_on_face', action='store_true', help='Whether to learn in w space instead of w+')
		self.parser.add_argument('--two_w_norm', action='store_true', help='Whether to learn in w space instead of w+')

		self.parser.add_argument('--fac_lambda', default=0, type=float, help='LPIPS loss multiplier factor')
		self.parser.add_argument('--mask_lambda', default=0, type=float, help='LPIPS loss multiplier factor')
		self.parser.add_argument('--mask_feat_lambda', default=0, type=float, help='LPIPS loss multiplier factor')
		...
		self.parser.add_argument('--w_norm_sketch_lambda', default=0, type=float, help='W-norm loss multiplier factor')
		...
		self.parser.add_argument('--coarse_encoder_checkpoint_path', default=None, type=str, help='Path to pSp model checkpoint')
